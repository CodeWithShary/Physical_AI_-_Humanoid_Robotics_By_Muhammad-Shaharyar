      ...
      <div className="footer-container">
        ...
        <div className="footer-column">
          ...
          <div className="footer-socials">
            <a href="https://www.linkedin.com/in/muhammad-shaharyar-113395297/" target="_blank" className="social-icon">
            ...
            <a href="https://github.com/CodeWithShary" target="_blank" className="social-icon">
              <div className='foot-icon'>
            ...
            <a href="mailto:muhammadshaharyar@gmail.com" className="social-icon">
              <div className='foot-icon'>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
